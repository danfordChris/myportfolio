    ...
    <div className="bg-gray-100 text-gray-800">
      <Container fluid className="resume-section">
        ...
        <Row className="mt-4">
          ...
          <Col md={4}>
            <div className="max-w-4xl mx-auto my-10 p-8 bg-white shadow-lg rounded-lg bg-gray-100 text-gray-800">
              <header className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p>+255 699 500 156</p>
                  <p>
                    <a href="mailto:jurvisdanford329@gmail.com" className="text-blue-500">
                      jurvisdanford329@gmail.com
                    </a>
                  </p>
                  <p>
                    <a href="http://danfordchriss.io" className="text-blue-500">
                      Danfordchriss.io
                    </a>
                  </p>
                </div>
              ...
              <section className="mt-8">
                <h3 className="text-3xl font-semibold border-b-2 border-pink-500 pb-2">
                  Profile
                </h3>
                <p className="mt-4">
                  I'm a passionate web designer with four years of experience.
                  Designed creative and responsive websites with 99% client
                  satisfaction.
                </p>
              </section>
              <section className="mt-8">
